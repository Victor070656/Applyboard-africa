            ...
            <div class="row">
                            ...
                            <div class="timeline border-start border-primary ps-3 ms-2">
                                ...
                                <div class="timeline-item mb-3">
                                    ...
                                    <p class="mb-0">
                                        ...
                                        <span class="badge bg-primary"><?= getStageLabelFromStage($history['to_stage']) ?></span>
                                    </p>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card mt-3">
                        ...
                        <div class="card-body">
                            <p class="text-muted small">Need help with your application? Contact our support team.</p>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-centered mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <td colspan="7" class="text-center">No cases found. <a href="index.php">Start an application</a></td>
                                            </tr>
                                        <?php else: ?>
