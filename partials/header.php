            ...
            <div class="nav-outer">
                <nav class="nav main-menu ">
                    <ul class="navigation">
                        ...
                        <li class="<?= $page == "platform" ? "current" : "" ?>">
            ...
            <ul class="contact-list-one">
                ...
                <li>
                    ...
                    <div class="contact-info-box">
                        ...
                        <a href="mailto:info@applyboardafrica.com"><span>info@applyboardafrica.com</span></a>
                    </div>
                </li>
                <li>
                    <!-- Contact Info Box -->
    ...
    <div class="sticky-header">
        <div class="auto-container">
            <div class="inner-container">
                <!--Logo-->
                <div class="logo">
                    <a href="./" title=""><img src="images/logo-2.png" style="height: 40px" alt="" title="ApplyBoard Africa Ltd" /></a>
                </div>
