...
if ($reportType === 'overview') {
     ...
     $stats = [
          ...
          'totalClients' => mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) as c FROM users WHERE created_at BETWEEN '$startDate' AND '$endDate'"))['c'],
                    ...
                    <div class="card mb-3">
                         <div class="card-body">
                              <div class="d-flex flex-wrap gap-4">
                                   <div class="report-tab <?= $reportType === 'overview' ? 'active' : '' ?>"
                                        onclick="location.href='reports.php?type=overview&period=<?= $period ?>'">
                                        <iconify-icon icon="solar:widget-2-outline"></iconify-icon> Overview
                                   </div>
                                   <div class="report-tab <?= $reportType === 'agents' ? 'active' : '' ?>"
                                        onclick="location.href='reports.php?type=agents'">
                                        <iconify-icon icon="solar:users-group-rounded-outline"></iconify-icon> Agent
                                        Performance
                                   </div>
                                   <div class="report-tab <?= $reportType === 'cases' ? 'active' : '' ?>"
                                        onclick="location.href='reports.php?type=cases'">
                                        <iconify-icon icon="solar:folder-with-files-outline"></iconify-icon> Case
                                        Analysis
                                   </div>
                                   <div class="report-tab <?= $reportType === 'financial' ? 'active' : '' ?>"
                                        onclick="location.href='reports.php?type=financial&period=<?= $period ?>'">
                                   ...
                                   <div class="card">
                                        <div class="card-header d-flex justify-content-between">
                                             ...
                                             <select class="form-select form-select-sm"
                                                  onchange="location.href='reports.php?type=overview&period='+this.value">
                                                  <option value="month" <?= $period === 'month' ? 'selected' : '' ?>>This Month
                                                  </option>
                                                  <option value="quarter" <?= $period === 'quarter' ? 'selected' : '' ?>>This
                                                       Quarter</option>
                                                  <option value="year" <?= $period === 'year' ? 'selected' : '' ?>>This Year
                                                  </option>
                                             </select>
                                        </div>
                                        <div class="card-body">
                                                       ...
                                                       <tr>
                                                            <td>
                                                                 ...
                                                                 <small class="text-muted">Since:
                                                                      <?= date('M Y', strtotime($agent['joined_date'])) ?></small>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                 <span class="badge bg-info"><?= $agent['active_cases'] ?>
                                                                      Active</span>
                                                                 <span class="badge bg-warning"><?= $agent['pending_cases'] ?>
                                                                      Pending</span>
                                                                 <span class="badge bg-success"><?= $agent['completed_cases'] ?>
                                                                      Completed</span>
                                                            </td>
                                                            ...
                                                            <td>
                                                                 <span
                                                                      class="badge bg-<?= $agent['status'] === 'verified' ? 'success' : 'secondary' ?>">
                              ...
                              <div class="col-md-3">
                                   <div class="card bg-info bg-opacity-10">
                                        <div class="card-body text-center">
                                             ...
                                             <h3>$<?= number_format($financialSummary['paid_amount'] + $financialSummary['pending_amount'], 2) ?>
                                             </h3>
                                        </div>
                                   </div>
                              </div>
