                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                ...
                                <small class="text-muted"><?= ucfirst($performance ? $performance['tier'] : 'bronze') ?> Tier</small>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($row['case_number']): ?>
                                                    ...
                                                    <br><small class="text-muted"><?= htmlspecialchars(substr($row['case_title'], 0, 30)) ?></small>
                                                <?php else: ?>
