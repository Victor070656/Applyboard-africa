                        ...
                        <div class="page-title-box d-flex justify-content-between align-items-center">
                            ...
                            <?php if ($unreadCount > 0): ?>
                                <a href="notifications.php" class="btn btn-outline-primary btn-sm">
                                    <iconify-icon icon="solar:bell-outline"></iconify-icon> <?= $unreadCount ?> New
                                    Notifications
                                </a>
                            <?php endif; ?>
                        </div>
                                                ...
                                                <div class="d-flex align-items-start">
                                                    <div class="flex-grow-1">
                                                        ...
                                                        <p class="mb-0 small text-muted">
                                                            <?= htmlspecialchars(substr($notif['message'], 0, 60)) ?>...</p>
                                                        <small
                            ...
                            <div class="card-body p-0">
                                <?php if (empty($recentCases)): ?>
                                    <div class="text-center py-5">
                                        ...
                                        <p class="text-muted mb-3">Start your journey by creating your first application.
                                        </p>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <iconify-icon icon="solar:graduation-cap-outline"
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <iconify-icon icon="solar:passport-outline"
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <iconify-icon icon="solar:airplane-outline"
                                ...
                                <div class="text-center mt-2">
                                    <a href="../services.php" class="btn btn-sm btn-outline-primary">View All
                                        Services</a>
                                </div>
                            </div>
                        </div>
