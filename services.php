...
$pageDescription = "Explore our comprehensive study abroad consulting, visa assistance, travel planning, and agent-based recruitment services at ApplyBoard Africa Ltd.";
...
<section class="page-hero">
  <div class="hero-bg">
    <img src="images/main-slider/2.jpg" alt="ApplyBoard Africa Services" />
  </div>
  <div class="hero-overlay"></div>
  <div class="hero-content">
    <p class="hero-subtitle">What We Offer</p>
    <h1>Our Services</h1>
    <p>Comprehensive education and travel consulting services designed to help you access global opportunities.</p>
  ...
  <div class="container">
    <div class="section-header text-center">
      ...
      <p class="section-description">
        From study abroad consulting to travel planning, we provide end-to-end support for all your international
        education and travel requirements.
      </p>
    </div>
    ...
    <div class="services-detail-grid">
      ...
      <div class="service-detail-card">
        ...
        <p>
          Our expert team handles all types of visa applications with precision and care, ensuring the highest approval
      ...
      <div class="service-detail-card">
        ...
        <h3>Study Abroad</h3>
        <p>
          Unlock world-class education opportunities with our comprehensive study abroad consultation and application
          support services.
        </p>
        <ul class="features-list">
      ...
      <div class="service-detail-card">
        ...
        <p>
          Achieve your target band score with our proven IELTS preparation program led by certified instructors and
      ...
      <div class="service-detail-card">
        ...
        <p>
          Navigate complex immigration processes with confidence. Our specialists guide you through every step of your
          relocation journey.
        </p>
        <ul class="features-list">
      ...
      <div class="service-detail-card">
        ...
        <p>
          Embark on your spiritual journey with our carefully curated Hajj and Umrah packages designed for a blessed and
      ...
      <div class="service-detail-card">
        ...
        <p>
          Get the best deals on domestic and international flights with our extensive airline partnerships and expert
          booking assistance.
        </p>
        <ul class="features-list">
...
<section class="section section-light">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p class="section-description">
        Our streamlined process makes it easy to get started on your journey. Here's how we help you every step of the
        way.
      </p>
    </div>
    ...
    <div class="process-timeline">
      <div class="process-step">
        ...
        <p>Schedule a free consultation to discuss your travel goals, requirements, and eligibility with our expert
          advisors.</p>
      </div>
  ...
  <div class="container">
    ...
    <div class="faq-container">
      <details class="faq-item">
        ...
        <p>Processing times vary depending on the visa type and destination country. Tourist visas typically take 2-4
          weeks, while work and immigration visas may take 2-6 months. Our team will provide you with accurate timelines
          based on your specific case.</p>
      </details>

      <details class="faq-item">
        <summary>What documents do I need for a visa application?</summary>
        <p>Required documents vary by visa type but generally include: valid passport, photographs, proof of funds,
          travel itinerary, accommodation details, and purpose of visit documentation. We provide a comprehensive
          checklist specific to your application.</p>
      </details>

      <details class="faq-item">
        <summary>Do you guarantee visa approval?</summary>
        <p>While we cannot guarantee approval as final decisions rest with embassies and consulates, we maintain an
          exceptionally high success rate through thorough preparation, accurate documentation, and expert guidance
          throughout the process.</p>
      </details>

      <details class="faq-item">
        <summary>What are your service fees?</summary>
        <p>Our fees vary based on the service type and complexity. We offer transparent pricing with no hidden charges.
          During your free consultation, we'll provide a detailed breakdown of all costs including our service fees and
          government charges.</p>
      </details>

      <details class="faq-item">
        <summary>Can you help if my visa was previously rejected?</summary>
        <p>Absolutely! We specialize in re-application cases. Our team will analyze your previous application, identify
          areas for improvement, and build a stronger case for your new application. Many of our clients have succeeded
          on their second attempt with our guidance.</p>
      </details>

      <details class="faq-item">
        <summary>Do you offer IELTS preparation for beginners?</summary>
        <p>Yes, our IELTS coaching program caters to all proficiency levels. Whether you're a beginner or looking to
          improve your score, our certified instructors will create a personalized study plan to help you achieve your
          target band score.</p>
      </details>

      <details class="faq-item">
        <summary>How can I track my application status?</summary>
        <p>Once you start an application with us, you'll receive access to our client portal where you can track your
          application status in real-time. You'll also receive email and SMS updates at every stage of the process.</p>
      </details>
    </div>
  </div>
</section>
