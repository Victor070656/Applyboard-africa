...
<section class="section section-white">
  <div class="container">
    ...
    <div class="service-selection-grid">
      <!-- Visa Processing -->
      <a href="<?php echo $isLoggedIn ? 'user/new_application.php?type=visa' : 'user/register.php?redirect=new_application&type=visa'; ?>" class="service-select-card">
        <div class="card-icon">
      ...
      <!-- Study Abroad -->
      <a href="<?php echo $isLoggedIn ? 'user/new_application.php?type=study' : 'user/register.php?redirect=new_application&type=study'; ?>" class="service-select-card featured">
      ...
      <!-- Hajj & Umrah -->
      <a href="<?php echo $isLoggedIn ? 'user/new_application.php?type=hajj' : 'user/register.php?redirect=new_application&type=hajj'; ?>" class="service-select-card">
        <div class="card-icon">
  ...
  <div class="container">
    <div class="referral-section">
      <div class="referral-content">
        ...
        <p>
          If you were referred by one of our agents, enter their referral code when registering to receive personalized support throughout your application process.
        </p>
      ...
      <div class="referral-image">
        <img src="images/travel/travel-2.jpg" alt="Agent Referral" />
      </div>
    </div>
  </div>
</section>
